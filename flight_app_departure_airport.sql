...
CREATE TABLE `departure_airport` (
  `departure_airport_id` int NOT NULL AUTO_INCREMENT,
  `departure_airport_name` varchar(255) NOT NULL,
  PRIMARY KEY (`departure_airport_id`)
...
INSERT INTO `departure_airport` VALUES (1,'Tp. Hồ Chí Minh'),(2,'Hà Nội'),(3,'Đà Nẵng'),(4,'Nha Trang'),(5,'Hải Phòng'),(6,'Huế'),(7,'Phú Quốc'),(8,'Đà Lạt'),(9,'Buôn Ma Thuột'),(10,'Điện Biên Phủ'),(11,'Thanh Hóa'),(12,'Qui Nhơn'),(13,'Cần Thơ'),(14,'Đồng Hới'),(15,'Vinh'),(16,'Rạch Giá');
